...
export const errorHandlingMiddleware = (err, req, res, next) => {
  ...
  // Tạo ra một biến responseError để kiểm soát những lỗi muốn trả về
  const responseError = {
  ...
  // nhằm bảo mật dự án khi không để production không nhìn được cấu trúc dự án của ta
